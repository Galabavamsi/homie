...
class MockMcpService
  ...
  @override
  Future<List<CartItem>> syncCart(String roomId, List<CartItem> cart) async =>
      cart;
  ...
  Future<List<OrderStep>> getOrderTracking(String orderId) async {
    ...
    return [
      OrderStep(
          ...
          subtitle: 'Swiggy MCP accepted the checkout',
          isComplete: true,
          timestamp: now.subtract(const Duration(minutes: 18))),
      OrderStep(
          title: 'Preparing',
          subtitle: 'Restaurant is packing the group order',
          isComplete: true,
          timestamp: now.subtract(const Duration(minutes: 12))),
      OrderStep(
          title: 'Picked up',
          subtitle: 'Delivery partner has the food',
          isComplete: true,
          timestamp: now.subtract(const Duration(minutes: 4))),
      OrderStep(
          title: 'On the way',
          subtitle: 'Arriving in 11 minutes',
          isComplete: false,
          timestamp: now),
      OrderStep(
          title: 'Delivered',
          subtitle: 'Everyone gets notified',
          isComplete: false,
